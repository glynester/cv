...
<li><a target="_blank" href = "http://fintimesrfuntimes.herokuapp.com/">Glenn Bemont - Github Account</a> - Website showing a list of FT news headlines with search functionality using FT Developer APIs to achieve this.<sub><sup>(http://fintimesrfuntimes.herokuapp.com/)</sup></sub></li>
