...
<b>Introduction</b><br>
Although I have a lot of relevant experience and have done a great deal of self learning, <span style="background-color: yellow>I have not specifically worked as a developer/coder in the industry.</span><br>
...
|<a target="_blank" href = "https://gb-node-weather-app-web-server.herokuapp.com/">Chat App</a> | App using 2 public API's to return weather details (nodejs, request) | <a target="_blank" href = "https://gb-node-weather-app-web-server.herokuapp.com/">https://bit.ly/3usVZd8</a> |
