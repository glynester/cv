...
<li><a href = "http://test.glynester.co.uk/data_collection_demo/Data_Collection_Form.php">Data Collection Form</a> - A configurable data collection form showing the configuration controller, the data collection form and the data collected on the same page.</li>
</ul>
